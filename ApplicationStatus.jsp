...
String pass1="@budhadev2509";
	...
	PreparedStatement ps=con.prepareStatement("select * from Applications join Jobs on Jobs.Jid=Applications.JobForeign where UserForeign=?");
                ...
                <div class="card" style="width: 18rem; height: 30rem">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">
                            ...
                            <p><b>Title: </b><%=rs.getString(9)%></p><br>
	  		  <p><b>Location: </b><%=rs.getString(10)%></p><br>
	  		  
	  		   <p><b>Category: </b><%=rs.getString(11)%></p><br>
	  		  <p><b>Job Status: </b><%=rs.getString(12)%></p><br>
	  	<p><b>Description: </b><%=rs.getString(13)%></p><br>
