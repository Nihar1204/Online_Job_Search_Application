...
<div style="background-color: grey">
	...
	long Di=Long.parseLong(di);
	  ...
	  String pass1="@budhadev2509";
	  	...
	  	PreparedStatement ps=con.prepareStatement("select * from Applications join JobSeeker on JobSeeker.SId=Applications.UserForeign join Jobs on Jobs.Jid=Applications.JobForeign where ReferId=?");
